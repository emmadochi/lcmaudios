...
export class MockDatabase {
  ...
  private seedData() {
    ...
    this.users = [
      {
        id: 'usr_covenant_1',
        email: 'grace.emmanuel@gmail.com',
        passwordHash: demoPasswordHash,
        fullName: 'Sister Grace Emmanuel',
        avatarUrl: 'https://images.unsplash.com/photo-1534528741775-53994a69daeb?auto=format&fit=crop&w=400&q=80',
        intentPreferences: ['deepWorship', 'morningDevotion'],
        subscriptionTier: 'annual',
        subscriptionStatus: 'active',
        subscriptionExpiresAt: new Date(Date.now() + 86400000 * 280).toISOString(),
        streamCount: 164,
        downloadCount: 14,
        totalListeningMinutes: 520,
        notesCount: 8,
        status: 'active',
      ...
      {
        id: 'usr_covenant_2',
        email: 'pastor.kalu@harvestlife.org',
        passwordHash: demoPasswordHash,
        fullName: 'Pastor Michael Kalu',
        avatarUrl: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?auto=format&fit=crop&w=400&q=80',
        intentPreferences: ['warfarePrayers', 'spiritual-growth'],
        subscriptionTier: 'annual',
        subscriptionStatus: 'active',
        subscriptionExpiresAt: new Date(Date.now() + 86400000 * 315).toISOString(),
        streamCount: 245,
        downloadCount: 22,
        totalListeningMinutes: 890,
        notesCount: 15,
        status: 'active',
      ...
      {
        id: 'usr_monthly_1',
        email: 'david.adeleke@yahoo.com',
        passwordHash: demoPasswordHash,
        fullName: 'David Adeleke',
        avatarUrl: 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?auto=format&fit=crop&w=400&q=80',
        intentPreferences: ['morningDevotion', 'praise'],
        subscriptionTier: 'monthly',
        subscriptionStatus: 'active',
        subscriptionExpiresAt: new Date(Date.now() + 86400000 * 21).toISOString(),
        streamCount: 92,
        downloadCount: 6,
      ...
      {
        id: 'usr_free_1',
        email: 'sarah.okon@outlook.com',
        passwordHash: demoPasswordHash,
        fullName: 'Sarah Okon',
        avatarUrl: 'https://images.unsplash.com/photo-1494790108377-be9c29b29330?auto=format&fit=crop&w=400&q=80',
        intentPreferences: ['deepWorship'],
        subscriptionTier: 'free',
        subscriptionStatus: 'active',
        streamCount: 41,
        downloadCount: 2,
        totalListeningMinutes: 135,
        notesCount: 2,
        status: 'active',
      ...
      {
        id: 'usr_free_2',
        email: 'john.peters@gmail.com',
        passwordHash: demoPasswordHash,
        fullName: 'John Peters',
        avatarUrl: 'https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?auto=format&fit=crop&w=400&q=80',
        intentPreferences: ['morningDevotion'],
        subscriptionTier: 'free',
        subscriptionStatus: 'active',
        streamCount: 9,
        downloadCount: 0,
        totalListeningMinutes: 32,
        notesCount: 0,
        status: 'active',
        lastActiveAt: new Date(Date.now() - 86400000 * 16).toISOString(),
